...
const RSI_LABELS = Array.from({ length: 49 }, (_, i) => (i === 48 ? "W0" : `W-${48 - i}`));
...
const consistencyStatus=(c)=>c>=36?"Highly Consistent":c>=24?"Moderately Consistent":c>=12?"Weak Consistency":"Low Consistency";
